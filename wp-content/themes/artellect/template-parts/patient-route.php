...
$title = $block['case_blocks_layout_patient-route_title'];
$repeater = $block['case_blocks_layout_patient-route_repeater'];


?>

<section class="em-check em-path" id="<?= $block['acf_fc_layout']; ?>">
        ...
        <?php foreach ($repeater as $index => $item): ?>
          <div class="em-check__card">
            <div class="em-check__card-title">
              ...
              <?= $item['case_blocks_layout_patient-route_repeater_title']; ?>
            </div>
            <div class="em-check__card-text">
              <?= $item['case_blocks_layout_patient-route_repeater_text']; ?>
            </div>
          </div>
        <?php endforeach; ?>
      </div>
